...
export enum EventType {
   ...
   */
  EXECUTION = 'execution',
  TASK_CLARIFICATION_NEEDED = 'task_clarification_needed',
}
...
export enum ExecutionState {
  ...
  TASK_CLARIFICATION_PROVIDED = 'task.clarification_provided',
  TASK_CLARIFICATION_CANCELLED = 'task.clarification_cancelled',
