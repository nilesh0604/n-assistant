...
export function convertCerebrasMessagesToLangChain(messages, extra) {
...
export function convertToCerebrasMessageParams(messages) {
...
export function formatToCerebrasToolChoice(toolChoice) {
    if (!toolChoice) {
        return undefined;
    }
