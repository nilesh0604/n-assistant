...
// node_modules/.pnpm/tsup@8.3.5_typescript@5.1.3/node_modules/tsup/assets/cjs_shims.js
  ...
  return {
    ...
    async resolveId(source, importer = "", opts) {
      ...
      if (import_node_path2.default.isAbsolute(source)) {
        ...
        id = import_node_path2.default.resolve(import_node_path2.default.dirname(importer), source);
      } else {
    ...
    async writeBundle(_, outputBundle) {
      ...
      Object.keys(bundleSourceMap).filter((name2) => cacheSourceMap[name2] || bundleSourceMap[name2] !== processedSourceMap[name2]).forEach((name2) => {
