 ...
 * <br />
 */
class ChatCerebras extends chat_models_1.BaseChatModel {
    static lc_name() {
        return "ChatCerebras";
    }
    get lc_secrets() {
    ...
    constructor(fields) {
        ...
        this.client = new cerebras_cloud_sdk_1.default({
            apiKey: fields.apiKey ?? (0, env_1.getEnvironmentVariable)("CEREBRAS_API_KEY"),
    ...
    invocationParams(options) {
        return {
            ...
            tools: options?.tools?.length
                ...
                : undefined,
            tool_choice: (0, utils_js_1.formatToCerebrasToolChoice)(options?.tool_choice),
        };
    }
    async _generate(messages, options, runManager) {
        ...
        const res = await this.caller.call(async () => {
            const res = await this.client.chat.completions.create({
                ...
                messages: (0, utils_js_1.convertToCerebrasMessageParams)(messages),
                stream: false,
            }, {
...
exports.ChatCerebras = ChatCerebras;
